...
interface Wan25VideoDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function Wan25VideoDialog({
  isOpen,
  onClose,
  videoUrl,
  prompt,
  ...
  resolution,
  aspectRatio,
}: Wan25VideoDialogProps) {
  const t = useTranslations("history.wan25");
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 rounded-xl border border-green-200/30 dark:border-green-800/30 p-4 space-y-3">
            ...
            {(duration || resolution || aspectRatio) && (
              <div className="flex flex-wrap gap-4 text-xs">
                ...
                {aspectRatio && (
                  <div>
                    <span className="text-muted-foreground">{t("aspect_ratio")}: </span>
