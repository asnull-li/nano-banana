  ...
  return (
    <section id={section.name} className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* 装饰线条 */}
        <svg className="absolute inset-0 w-full h-full opacity-20 [.dark_&]:opacity-30" xmlns="http://www.w3.org/2000/svg">
          <defs>
      ...
      <div className="container relative">
        ...
        <div className="text-center mb-16">
          {section.label && (
            <Badge className="mb-6 bg-gradient-to-r from-green-500/10 to-cyan-500/10 [.dark_&]:from-green-400/20 [.dark_&]:to-cyan-400/20 text-green-700 [.dark_&]:text-green-300 border-green-500/30 [.dark_&]:border-green-400/40 px-4 py-1.5 text-xs font-semibold">
              {section.label}
            </Badge>
          )}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          {section.items?.map((item, index) => (
            ...
            >
              {/* 卡片背景光效 */}
              <div className={`absolute -inset-0.5 bg-gradient-to-r from-green-500 to-cyan-500 [.dark_&]:from-green-400 [.dark_&]:to-cyan-400 rounded-2xl opacity-0 group-hover:opacity-30 blur-sm transition-all duration-500 ${
                ...
                <div className="flex gap-4">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="relative w-12 h-12 bg-gradient-to-br from-green-500/20 to-cyan-500/20 [.dark_&]:from-green-400/30 [.dark_&]:to-cyan-400/30 group-hover:from-green-500 group-hover:to-cyan-500 [.dark_&]:group-hover:from-green-400 [.dark_&]:group-hover:to-cyan-400 rounded-xl flex items-center justify-center transition-all duration-300">
                      <span className="text-sm font-bold text-green-600 [.dark_&]:text-green-400 group-hover:text-white transition-colors">
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <div className="h-px flex-1 bg-gradient-to-r from-transparent via-green-500/20 to-transparent [.dark_&]:via-green-400/30" />
                      <span className="text-xs text-green-600/60 [.dark_&]:text-green-400/60 px-2">
                        FAQ
                      </span>
                      <div className="h-px flex-1 bg-gradient-to-r from-transparent via-cyan-500/20 to-transparent [.dark_&]:via-cyan-400/30" />
                    </div>
                  </div>
                  ...
                  <div className="flex-shrink-0 self-start opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-2">
                    <svg className="w-6 h-6 text-green-500 [.dark_&]:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 text-center">
          <p className="text-sm text-slate-500 [.dark_&]:text-slate-400">
            Have more questions?
            <a href="#" className="ml-2 text-green-600 [.dark_&]:text-green-400 hover:text-green-700 [.dark_&]:hover:text-green-300 font-semibold transition-colors">
